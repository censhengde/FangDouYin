...
/**
 * 第一层filter，从renderer的sufacetextuer读出数据不需要显示到屏幕上
 * 写入fbo (帧缓存)
 */
...
//        };
    ...
    /**画画，本质就是传值给.vert,.frag
     * @param textureId：SufaceTexture纹理
     * @return 返回FBO纹理Id
     */
    @Override
    public int onDrawFrame(int textureId) {
        ...
        //因为这一层是摄像头后的第一层，还是从SufaceTexture采样，所以需要使用扩展的  GL_TEXTURE_EXTERNAL_OES
